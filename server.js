...
// ============================================
// FUNCIONES PARA STORAGE (usando bucket 'Productos' con mayúscula)
// ============================================
...
async function uploadToSupabase(file, folder = 'Productos') {
    try {
        ...
        const { data, error } = await supabase.storage
            .from(folder)  // folder = 'Productos' (con mayúscula)
...
async function deleteFromSupabase(imageUrl) {
    try {
        ...
        // Buscar el bucket 'Productos' (con mayúscula) en la URL
...
// CREAR PRODUCTO - Con subida a Supabase Storage (bucket 'Productos' con mayúscula)
